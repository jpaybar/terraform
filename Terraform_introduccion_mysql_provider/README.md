...
![original_mysql_container.PNG](C:\LABO\vagrant\TERRAFORM\Terraform_introduccion_mysql_provider\_images\original_mysql_container.PNG)
...
![terraform_plan.PNG](C:\LABO\vagrant\TERRAFORM\Terraform_introduccion_mysql_provider\_images\terraform_plan.PNG)

Confirmamos que es la planificación deseada y ejecutamos `terraform apply`:

![terraform_apply.PNG](C:\LABO\vagrant\TERRAFORM\Terraform_introduccion_mysql_provider\_images\terraform_apply.PNG)
...
![mysql_container_1cambio_db.PNG](C:\LABO\vagrant\TERRAFORM\Terraform_introduccion_mysql_provider\_images\mysql_container_1cambio_db.PNG)

Y que también se ha creado el usuario `jpayan`:

![mysql_container_1cambio_usuario.PNG](C:\LABO\vagrant\TERRAFORM\Terraform_introduccion_mysql_provider\_images\mysql_container_1cambio_usuario.PNG)
...
![mysql_container_2cambio_other_user.PNG](C:\LABO\vagrant\TERRAFORM\Terraform_introduccion_mysql_provider\_images\mysql_container_2cambio_other_user.PNG)
